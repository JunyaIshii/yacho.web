...
export const createSiteMember = createAsyncThunk(
    ...
    async ({ email, siteId }: { email: string; siteId: number }, thunkAPI) => {
        try {
            const { data } = await axios.post("/api/siteMembers/store", {
                email: email,
                site_id: siteId,
            });
            return data;
...
export const updateSiteMember = createAsyncThunk(
    ...
    async ({
        ...
        const { data } = await axios.post("/api/siteMembers/update", {
            id: siteMemberId,
...
export const removeSiteMember = createAsyncThunk(
    ...
    async ({
        ...
        const { data } = await axios.post("/api/siteMembers/destroy", {
